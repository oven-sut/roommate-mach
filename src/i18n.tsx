...
const dict: Dict = {
  ...
  housingPrefs: { en: "Housing preferences", th: "ความต้องการเรื่องที่พัก" },
  edit: { en: "Edit", th: "แก้ไข" },
  studyYear: { en: "Year of study", th: "ชั้นปี" },
  chooseYear: { en: "Choose your year", th: "เลือกชั้นปี" },
  preferredZone: { en: "Preferred area", th: "โซนที่อยากอยู่" },
  chooseZone: { en: "Choose an area", th: "เลือกโซน" },
  zoneGate1: { en: "Gate 1", th: "ประตู 1" },
  zoneGate2: { en: "Gate 2", th: "ประตู 2" },
  zoneGate3: { en: "Gate 3", th: "ประตู 3" },
  zoneGate4: { en: "Gate 4", th: "ประตู 4" },
  zoneOffCampus: { en: "Off-campus", th: "นอกมหาวิทยาลัย" },
  monthlyBudget: { en: "Monthly budget", th: "งบต่อเดือน" },
  budgetHint: {
    en: "Used to match you with people in the same price range",
    th: "ใช้จับคู่กับคนที่งบใกล้เคียงกัน",
  },
  ...
  double: { en: "Double (2 beds)", th: "ห้องคู่ (2 คน)" },
  triple: { en: "Triple (3 beds)", th: "ห้อง 3 คน" },
  groupRoom: { en: "Group (3-4+ beds)", th: "ห้องพักกลุ่ม (3-4 คนขึ้นไป)" },
  either: { en: "Either / Any", th: "ได้ทุกแบบ" },
